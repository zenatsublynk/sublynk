...
.page{width:1403px;height:1815px;display:flex;flex-direction:column;position:relative}
.pad{padding:0 74px}
...
.sub{font-size:27px;font-weight:500;line-height:1.3;color:#4a453f;margin-top:14px;max-width:22ch}
...
/* pain */
.pain{margin-top:22px;background:var(--pain);border-left:8px solid var(--orange);border-radius:0 14px 14px 0;padding:18px 28px}
...
/* footer */
.footer{margin-top:auto;background:var(--navy);padding:26px 74px;display:flex;align-items:center;justify-content:space-between;gap:24px}
